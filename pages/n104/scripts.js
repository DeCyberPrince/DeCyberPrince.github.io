let timetable = {
    perm: {
        weekday: ['06:05','06:30','06:50','07:10','07:25','07:45','08:20','08:50','09:10','09:40','10:00','10:20','11:00','11:30','12:00','12:30','13:05','13:40','14:00','14:20','14:45','15:05','15:25','15:55','16:30','16:50','17:10','17:30','17:50','18:20','18:45','19:00','19:25','19:50','20:10','20:40','21:20','21:50'],
        weekend: ['06:05','06:50','07:25','07:55','08:20','09:10','09:40','10:20','11:30','12:30','13:05','13:40','14:20','15:25','15:55','16:30','17:10','17:50','18:20','19:00','19:50','20:40','21:20','21:50'],
        get weekendIndexes() {let arr = [];for (let time of this.weekend) {arr.push(this.weekday.indexOf(time));}return arr;}
    },
    gamovo: {
        weekday: ['06:00','06:20','07:00','07:30','07:55','08:20','08:40','09:05','09:30','10:00','10:30','11:00','11:20','11:35','12:00','12:30','13:00','13:30','14:00','14:30','14:50','15:20','15:35','15:55','16:30','17:00','17:30','18:30','18:50','19:10','19:40','20:15','20:50','21:25','22:00*','22:35*'],
        weekend: ['06:30','07:00','07:50','08:30','09:10','09:30','10:30','11:00','11:35','12:30','13:30','14:00','14:50','15:35','16:30','17:00','17:30','18:30','19:10','19:40','20:15','20:50','21:30','22:20*'],
        get weekendIndexes() {let arr = [];for (let time of this.weekend) {arr.push(this.weekday.indexOf(time));}return arr;}
    }
}
let now = {
...
$(document).ready(function(){
    ...
    function timeMagic() {
        if ($(this).hasClass('transformed')) {
            ...
            boxTime[1] = parseFloat(boxTime[1]);
